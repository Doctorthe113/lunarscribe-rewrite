...
export function FileRename() {
  ...
  return (
    <Input
      className="relative mx-auto h-6 w-min min-w-0 -translate-x-1/2 cursor-pointer border-none text-center text-primary shadow-none ring-0 xl:absolute xl:left-1/2 dark:bg-transparent"
      ref={inputRef}
